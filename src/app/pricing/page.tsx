    ...
    <main>
      ...
      <section className="pt-8 md:pt-14 pb-14 bg-[#F6F6F8]">
        <div className="container-main text-center">
          ...
          {/* Pricing Card */}
          <div className="max-w-lg mx-auto bg-white rounded-3xl shadow-lg border border-gray-100 overflow-hidden">
            {/* Price header */}
            <div className="px-20 pt-7 pb-5 text-center border-b border-gray-200">
